...
class UW_Module
{
  ...
  const MODULE_GIVE      = '<div class="module give-module module-%s"><div class="giving-frame">[iframe src="https://online.gifts.washington.edu/secure/?source_typ=3&source=%s" width="660" height="743"]</div><div class="giving-mod-how-to"><h3>How to use</h3><p><ul><li class="p1"><span class="s2">Not sure where to give? Check out the <b>Greatest Needs </b>tab and support the areas that need you most.</span></li><li class="p1"><span class="s2">Looking for a particular fund in a college, school, or department? In the <b>Search</b> bar, type in any key word and click <b>Go!</b></span></li><li class="p1"><span class="s2">Renewing your gift? Amazing! Log in to see your <b>Gift History </b>and support your favorites.</span></li><li class="p1"><span class="s2">Having trouble? Contact us at <a href="mailto:give2uw@uw.edu"><span class="s3">give2uw@uw.edu</span></a> or at 1-800-326-7566 or 206-685-1980. We are here to help!</span></li></ul></p></div></div>';
